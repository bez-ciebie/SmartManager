# -*-coding  :  UTF_8 _*_
# 创建时间： 2022/8/23 14:47   # 开发者：Wei Zihao
...
class Ui_Form(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.label_2.setGeometry(QtCore.QRect(40, 50, 51, 51))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("../img/figure.jpg"))
        self.label_2.setScaledContents(True)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self)
        self.label_3.setGeometry(QtCore.QRect(50, 120, 141, 41))
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap("../img/house.png"))
        self.label_3.setScaledContents(True)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self)
        self.label_4.setGeometry(QtCore.QRect(50, 170, 141, 41))
        self.label_4.setText("")
        self.label_4.setPixmap(QtGui.QPixmap("../img/house.png"))
        self.label_4.setScaledContents(True)
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self)
        self.label_5.setGeometry(QtCore.QRect(50, 270, 141, 41))
        self.label_5.setText("")
        self.label_5.setPixmap(QtGui.QPixmap("../img/house.png"))
        self.label_5.setScaledContents(True)
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self)
        self.label_6.setGeometry(QtCore.QRect(50, 220, 141, 41))
        self.label_6.setText("")
        self.label_6.setPixmap(QtGui.QPixmap("../img/house.png"))
        ...
        self.label_11.setPixmap(QtGui.QPixmap("../img/figure.jpg"))
        self.label_11.setScaledContents(True)
        self.label_11.setObjectName("label_11")
        self.label_12 = QtWidgets.QLabel(self)
        self.label_12.setGeometry(QtCore.QRect(190, 230, 251, 151))
        self.label_12.setText("")
        self.label_12.setPixmap(QtGui.QPixmap("../img/figure.jpg"))
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_15.setText(_translate("Form", "Timeskill!"))
